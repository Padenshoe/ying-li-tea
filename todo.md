...
- [x] 修復「立即購買」按鈕間歇性 bug（前端商品 ID 綁定邏輯）
- [x] 為每款商品建立獨立詳細頁面（/products/:id），含完整商品資訊與加入購物車功能
- [x] 商品頁和購物車頁提早顯示運費門檻（NT$2000 免運，差額提示）
- [x] 首頁商品卡加上價格標示（阿里山茶包禮盒 NT$980）

## 經典迎利茶葉禮盒與聯名禮盒照片更新

- [x] 上傳經典迎利茶葉禮盒與聯名禮盒首圖所需照片至網站資產空間
- [x] 新增「經典迎利茶葉禮盒」商品（阿里山茶葉 4 兩＋頂級大禹嶺茶葉 2 兩，NT$2,500）至中秋聯名禮盒頁面，並支援加入購物車
- [x] 新增經典迎利茶葉禮盒至精選茶葉頁面的推薦分類及獨立商品詳情頁
- [x] 依指定照片順序更新三款既有中秋聯名禮盒首圖
- [x] 驗證 TypeScript、測試與產品圖片顯示（TypeScript 零錯誤；新增 2 個禮盒目錄測試後共 43 個測試通過）

### 本次驗證紀錄

- 已開啟 `/mid-autumn`：四款禮盒卡片皆可見，新經典禮盒顯示 NT$2,500 與三張指定圖片；MA01／MA02／MA03 的首圖已依指定替換。
- 已開啟 `/products/MA04`：商品名稱、NT$2,500、重量、三張圖片、加入購物車與立即購買按鈕均正常顯示。
