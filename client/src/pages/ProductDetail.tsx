...
const PRODUCTS: ProductDetail[] = [
  ...
  {
    id: "GB01", name: "精選茶葉禮盒（半斤裝）", season: "禮盒", weight: "300g（半斤）", price: 1580,
    images: [IMG.giftbox1], nameKey: "product.giftbox.half",
    description: "精選台灣高山茶，搭配典雅禮盒包裝，半斤裝，適合送禮自用兩相宜。可從三種春茶選擇，如需客製其他茶葉，請另外私訊或在結帳備註說明。",
    notes: ["精選台灣高山春茶，典雅禮盒包裝", "半斤裝，適合送禮自用兩相宜", "如需客製不同茶葉，請另外私訊或在結帳備註說明"],
    teaOptions: [
  ...
  {
    id: "GB02", name: "拾遇茶葉禮盒（半斤裝）", season: "禮盒", weight: "300g（半斤）", price: 1580,
    images: [IMG.giftbox2], nameKey: "product.giftbox.shiyou",
    description: "拾遇系列，質感鐵罐搭配精緻外盒，半斤裝雙罐組，送禮首選。可從三種春茶選擇，如需客製其他茶葉，請另外私訊或在結帳備註說明。",
    notes: ["拾遇系列，質感鐵罐搭配精緻外盒", "半斤裝雙罐組，送禮首選", "如需客製不同茶葉，請另外私訊或在結帳備註說明"],
    teaOptions: [
      { label: "阿里山春茶", price: 1580 },
      { label: "梨山新佳陽春茶", price: 2380 },
      { label: "福壽山春茶", price: 3980 },
  ...
  {
    id: "GB05", name: "精選茗茶禮盒", season: "禮盒", weight: "300g（半斤）", price: 800,
    images: [IMG.giftboxJingXuan], nameKey: "product.giftbox.jingxuan",
    description: "青花瓷風格鐵罐，典雅精致，半斤裝雙罐組，適合送禮收藏。可從三種高山烏龍茶選擇，如需客製其他茶葉，請另外私訊或在結帳備註說明。",
