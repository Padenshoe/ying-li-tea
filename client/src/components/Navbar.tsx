  ...
  return (
    ...
    >
      <div className="container flex items-center justify-between h-16 md:h-20">
        ...
        >
          <span
            className="font-['Playfair_Display'] text-xl md:text-2xl font-medium tracking-wide"
            style={{ color: "oklch(0.265 0.015 55)" }}
          >
            Ying-Li
          </span>
          <span
            className="text-[0.55rem] tracking-[0.22em] uppercase font-['Lato'] font-400 mt-0.5"
