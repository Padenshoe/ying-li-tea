...
const featureKeys = [
  { headingKey: "why.qingxin", bodyKey: "why.qingxinDesc" },
  { headingKey: "why.clean", bodyKey: "why.cleanDesc" },
  { headingKey: "why.quality", bodyKey: "why.qualityDesc" },
  { headingKey: "why.tradition", bodyKey: "why.traditionDesc" },
];
    ...
    >
      <div className="container">
        ...
        <div className="mb-16 md:mb-20">
          <span className="eyebrow reveal">{t("why.title")}</span>
