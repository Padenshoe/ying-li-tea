...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "product.giftbox.half": "精選茶葉禮盒（半斤裝）",
    "product.giftbox.shiyou": "拾遇茶葉禮盒（半斤裝）",
    "product.giftbox.full": "圓善茶葉禮盒（一斤裝）",
    "product.giftbox.yubao": "台灣御寶禮盒",
    "product.giftbox.jingxuan": "精選茗茶禮盒",
    "product.giftbox.caiyun": "采韻禮盒",
    "product.giftbox.yuxi": "御璽金賞包裝",
    "product.dayuling.spring": "頂級大禹嶺春茶",
    "product.lishan.tieguanyin": "梨山鐵觀音",
    "product.lishan.blacktea": "梨山烏龍紅茶",
    "product.lishan.premiumblack": "梨山頂級紅茶",
    "product.shuixian.blacktea": "水仙紅茶",
    "product.contest.lishan.top": "Lishan Tea King Gold Award Gift Box",
    "product.contest.renai.top": "Renai Township Farmers' Assoc. Gold Award",
    "product.contest.heping.3star": "Heping District Lishan 3-Star Award",
    "product.giftbox.classic": "Classic Yingli Tea Gift Box",
    ...
    "checkout.subtitle": "Please confirm your details before submitting.",
    ...
    "checkout.deliveryHomeTitle": "Home Delivery",
    "checkout.deliveryHomeDesc": "Deliver to your specified address",
    "checkout.delivery711Title": "7-11 Pickup",
    "checkout.delivery711Desc": "Pickup at 7-ELEVEN stores",
    ...
    "checkout.submitHint": "Estimated delivery: 1–3 business days after order placement.",
  ...
  zh: {
    ...
    "product.lishan.premiumblack": "梨山頂級紅茶",
    "product.shuixian.blacktea": "水仙紅茶",
    "product.contest.lishan.top": "梨山茶王頭等獎禮盒",
    "product.contest.renai.top": "仁愛鄉農會高山茶王頭等獎",
    "product.contest.heping.3star": "和平區梨山茶王三星獎",
    "product.giftbox.classic": "經典迎利茶葉禮盒",
    "product.teaBagGiftBox": "茶包禮盒",
    "product.teaBagGiftBoxTag": "禮盒精選",
    "product.teaBagGiftBoxDesc": "精心設計的茶包禮盒，適合送禮自用。方便沖泡，保留台灣高山茶的原始香氣。",
    ...
    "faq.q6": "迎利有提供批發服務嗎？",
    "faq.a6": "有的！我們提供台灣高山茶各種茶款批發。批發以「顆」為單位計算，一顆為 30 斤，歡迎有需要大量批發的客戶直接來店裡詢問。",
    ...
    "checkout.deliveryHomeTitle": "宅配",
    "checkout.deliveryHomeDesc": "送到您指定的地址",
    "checkout.delivery711Title": "7-11 店到店",
    "checkout.delivery711Desc": "在 7-ELEVEN 門市取貨，僅限 7-ELEVEN",
    ...
    "checkout.submitHint": "預計1至3個工作日到貨",
